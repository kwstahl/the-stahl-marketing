      ...
      <section className="relative py-40 px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-start mb-20">
            ...
            {/* Card 2 - The Stahl Launch */}
            <div className="bg-white/95 backdrop-blur-sm border border-[#0A203F]/10 p-12 hover:shadow-2xl transition-all duration-500 hover:border-[#0A203F]/20 group">
              <div className="mb-6">
                <div className="w-12 h-[1px] bg-[#AC9F8D] mb-8 group-hover:w-16 transition-all duration-500"></div>
                <h3 className="text-2xl text-[#0A203F] mb-6 leading-tight font-serif">The Stahl Launch™</h3>
              </div>
              <p className="text-[#6F6C5D] leading-relaxed mb-10 text-[15px]">
                Strategic one-page website starting at $1,200. A conversion-focused, upgrade-ready site built for early-stage founders who need a strong digital presence without overbuilding.
              </p>
              <Link to="/services/stahl-launch-package" className="text-[#0A203F] tracking-[0.2em] text-xs uppercase hover:text-[#203F4F] transition-colors inline-flex items-center gap-2 group-hover:gap-3 duration-300">
                LEARN MORE <span>→</span>
              </Link>
            </div>

            {/* Card 3 - Squarespace Website Design */}
            <div className="bg-[#0A203F] p-12 hover:shadow-2xl transition-all duration-500 hover:border-[#AC9F8D]/40 border border-transparent group">
              <div className="mb-6">
                <div className="w-12 h-[1px] bg-white/40 mb-8 group-hover:w-16 transition-all duration-500"></div>
                <h3 className="text-2xl text-white mb-6 leading-tight font-serif">Squarespace Website Design</h3>
              </div>
              <p className="text-white/80 leading-relaxed mb-10 text-[15px]">
                Multi-page website designed to position your business as an industry leader. Built with strategy, structure, and long-term growth in mind. Starting at $6,000.
              </p>
              <Link to="/services/authority-website-package" className="text-white tracking-[0.2em] text-xs uppercase hover:text-white/80 transition-colors inline-flex items-center gap-2 group-hover:gap-3 duration-300">
                LEARN MORE <span>→</span>
              </Link>
            </div>

            {/* Card 4 - The Stahl Foundation™ */}
            <div className="bg-white/95 backdrop-blur-sm border border-[#0A203F]/10 p-12 hover:shadow-2xl transition-all duration-500 hover:border-[#0A203F]/20 group">
              <div className="mb-6">
                <div className="w-12 h-[1px] bg-[#AC9F8D] mb-8 group-hover:w-16 transition-all duration-500"></div>
                <h3 className="text-2xl text-[#0A203F] mb-6 leading-tight font-serif">The Stahl Foundation™</h3>
              </div>
              <p className="text-[#6F6C5D] leading-relaxed mb-10 text-[15px]">
                Complete brand and website build designed to position your business as a long-term authority. Your full digital foundation built correctly from the start. Starting at $10,000.
              </p>
              <Link to="/services/full-infrastructure-package" className="text-[#0A203F] tracking-[0.2em] text-xs uppercase hover:text-[#203F4F] transition-colors inline-flex items-center gap-2 group-hover:gap-3 duration-300">
                LEARN MORE <span>→</span>
              </Link>
            </div>
          </div>
