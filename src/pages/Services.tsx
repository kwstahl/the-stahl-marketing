      ...
      <section className="bg-[#0A203F] py-20 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12">
            ...
            {/* Card 2 - Website Design (Clickable) */}
            <Link to="/services/web-design-package" className="text-center border-l border-white/20 group cursor-pointer block transition-transform duration-500 hover:-translate-y-3">
              <div className="mb-6 overflow-hidden rounded-lg backdrop-blur-md bg-white/10 border border-white/20 p-1 transition-all duration-500 group-hover:bg-white/30 group-hover:border-[#AC9F8D]/60 group-hover:shadow-[0_20px_60px_rgba(172,159,141,0.3)]">
                <img
                  src={websiteImage}
            ...
            {/* Card 3 - The Stahl Foundation (Clickable) */}
            <Link to="/services/full-brand-suite-package" className="text-center border-l border-white/20 group cursor-pointer block transition-transform duration-500 hover:-translate-y-3">
              <div className="mb-6 overflow-hidden rounded-lg backdrop-blur-md bg-white/10 border border-white/20 p-1 transition-all duration-500 group-hover:bg-white/30 group-hover:border-[#AC9F8D]/60 group-hover:shadow-[0_20px_60px_rgba(172,159,141,0.3)]">
                <img
                  src={foundationImage}
                  alt="The Stahl Foundation website mockup"
                  className="w-full h-48 object-cover transition-transform duration-700 group-hover:scale-125 rounded"
                />
              </div>
            ...
            {/* Card 4 - Social Media (Clickable) */}
            <Link to="/services/social-media-package" className="text-center border-l border-white/20 group cursor-pointer block transition-transform duration-500 hover:-translate-y-3">
              <div className="mb-6 overflow-hidden rounded-lg backdrop-blur-md bg-white/10 border border-white/20 p-1 transition-all duration-500 group-hover:bg-white/30 group-hover:border-[#AC9F8D]/60 group-hover:shadow-[0_20px_60px_rgba(172,159,141,0.3)]">
                <img
              ...
              <h3 className="text-2xl text-white mb-2 font-serif transition-colors duration-300 group-hover:text-[#AC9F8D]">Social Media Packages</h3>
              <p className="text-white/80 text-sm tracking-widest uppercase transition-all duration-300 group-hover:text-white">Starting at $1,500/month</p>
            </Link>
          </div>
        </div>
      </section>
